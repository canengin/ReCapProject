...
namespace Business.Concrete
{
    public class PaymentManager : IPaymentService
    {
        ...
        public IResult Delete(Payment entity)
        {
            ...
            return new SuccessResult("Ödeme" + Messages.DeleteSingular);
        }
        ...
        public IDataResult<Payment> FindByID(int Id)
        {
            ...
            else Console.WriteLine(Messages.NotExist + "Ödeme");
        ...
        public IResult Update(Payment entity)
        {
            ...
            return new SuccessResult("Ödeme" + Messages.UpdateSingular);
        }
